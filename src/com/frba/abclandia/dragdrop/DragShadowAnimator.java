...
public class DragShadowAnimator {
	...
	private void updateViewLayout(DragShadow view, Integer x, Integer y,
			Integer w, Integer h) {
		if (view != null) {
	...
	public void translateXY(final DragShadow viewToAnimate,
			DragSource originalDragView, int viewX, int endX, int viewY,
			int endY) {
